...
public class BruteForceAlgorithm implements Algorithm {
	...
	public int[][][] scheduleShifts() {
		...
		int[][][] bestSolution = getOptimalSolution(bruteforceOptionalResults, this.shiftRequests);

		return bestSolution;
	}

	public int[][][] getOptimalSolution(ArrayList<int[][][]> optionalSolutions, int[][][] constraints) {
